...
export class SceneRenderer extends SceneRendererBase {
   ...
   */
  public setAutoFogUpdate(autoUpdate: boolean): void {
  ...
  constructor(container?: HTMLElement | string, options: SceneRendererOptions = {}) {
    ...
    if (bloom && bloom.enabled && !useWebGPU) {
      ...
      this.composer = new EffectComposer(this.renderer as WebGLRenderer, renderTarget);
   ...
   */
  public resize() {
    if (!this._isRendererReady) return this;
