...
import { PaintConfig, PaintRule } from "../style";
...
export declare class VectorTileRenderLayer extends OverlayLayer<Feature> {
     ...
     * Worker 管理器，用于线程外处理
     */
    _workerManager: VectorTileWorkerManager;
     ...
     * 使用 Worker 处理瓦片数据（异步）
     */
    processTileDataAsync(tile: Tile, data: any): Promise<void>;
    /**
